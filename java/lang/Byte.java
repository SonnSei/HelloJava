...
public final class Byte extends Number implements Comparable<Byte> {
     ...
     * @since  1.5
     */
    public static Byte valueOf(byte b) { // 自动装箱就是调用的这个方法
     ...
     */
    public static byte parseByte(String s) throws NumberFormatException {  // 自动拆箱
     ...
     */
    @Override
    public int hashCode() {  // Byte的hashCode就是其value
     ...
     * @since 1.8
     */
    public static int toUnsignedInt(byte x) { // &0xff的意思就是只取后8位，前8位置零
        return ((int) x) & 0xff;
    }
